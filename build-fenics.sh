...
cd $BUILD_DIR && \
   ...
   mkdir -p build && \
   cd build && \
   cmake ../ -DCMAKE_INSTALL_PREFIX=${PREFIX} -DBLAS_LIBRARIES=/home/ramisetti/apps/fenics-2019.1.0.r1/lib/libfblas -DUMFPACK_LIBRARIES=/home/ramisetti/apps/fenics-2019.1.0.r1/lib/libumfpack.a -DSUNDIALS_LIBRARIES=/home/ramisetti/apps/fenics-2019.1.0.r1/lib/libsundials_nvecparallel.a -DCMAKE_BUILD_TYPE=Release -DDOLFIN_SKIP_BUILD_TESTS=true && \
   make && \
   make install
